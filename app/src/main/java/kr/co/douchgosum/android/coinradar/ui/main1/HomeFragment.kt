package kr.co.douchgosum.android.coinradar.ui.main1
...
class HomeFragment : BaseFragment() {
    ...
    private fun getTabTitle(position: Int): String? {
        return when (position) {
            SUB1_INDEX -> getString(R.string.main1_sub1_title)
            SUB2_INDEX -> getString(R.string.main1_sub2_title)
            SUB3_INDEX -> getString(R.string.main1_sub3_title)
            else -> null
        }
    }
